              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-teal-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">방 참가</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => ['room_join', 'member_join'].includes(a.type)).length > 0 ? (
                      recentActivities.filter(a => ['room_join', 'member_join'].includes(a.type)).slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-red-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">멤버 강퇴</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'member_kick').length > 0 ? (
                      recentActivities.filter(a => a.type === 'member_kick').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-yellow-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">자리 요청</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'slot_request').length > 0 ? (
                      recentActivities.filter(a => a.type === 'slot_request').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-emerald-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">자리 양보</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'slot_yield').length > 0 ? (
                      recentActivities.filter(a => a.type === 'slot_yield').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-pink-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">자리 교환</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'slot_swap').length > 0 ? (
                      recentActivities.filter(a => a.type === 'slot_swap').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-orange-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">협상 시작</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'negotiation_start').length > 0 ? (
                      recentActivities.filter(a => a.type === 'negotiation_start').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                {/* 협상 해결 */}
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-lime-500">
                  <div className="flex items-center gap-2 mb-3">
                    <TrendingUp size={16} className="text-lime-500" />
                    <span className="font-medium text-gray-700">협상 해결</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'negotiation_resolve').length > 0 ? (
                      recentActivities.filter(a => a.type === 'negotiation_resolve').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow p-4 border-l-4 border-indigo-500">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-medium text-gray-700">자동 배정</span>
                  </div>
                  <div className="space-y-2 max-h-[150px] overflow-y-auto">
                    {recentActivities.filter(a => a.type === 'auto_assign').length > 0 ? (
                      recentActivities.filter(a => a.type === 'auto_assign').slice(0, 5).map((activity, index) => (
                        <div key={index} className="flex justify-between items-center text-sm">
                          <span className="text-gray-800 truncate">{activity.userName}</span>
                          <span className="text-xs text-gray-400 whitespace-nowrap ml-2">{formatDateTime(activity.createdAt)}</span>
                        </div>
