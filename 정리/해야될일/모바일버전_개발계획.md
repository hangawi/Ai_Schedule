...
### 43. **달력 점심시간 미표시 문제**
   - 증상: 달력 페이지에서 점심시간이 안 나옴. 날짜를 다시 클릭하면 일간 뷰로 변환되면서 다시 생김
   - 원인: 달력 날짜를 클릭해야만 해당 날짜의 일정이 표시됨
   - 해결: (대기)
   - 파일: `MobileCalendarView.js`
...
### 46. **모든 페이지 하단 버튼 활성화**
   - 요구사항: 모든 페이지(홈/일정/그룹/달력)에 하단 버튼 표시
     ...
     - ⏳ 마이크 버튼: 보류
   - 해결: (대기)
   - 파일: `MobileDashboard.js`, `MobileScheduleView.js`, `MobileGroupsView.js`, `MobileCalendarView.js`, `BottomNavigation.js`
...
## 🚀 작업 순서
1. ✅ 44번 → 2. ✅ 43번 → 3. ✅ 46번 → 4. ✅ 42번 → 5. ✅ 41번 → 6. ✅ 45번
