...
🚨 **날짜 해석 핵심 규칙:**
   - "이번 주 X요일" → **이번주 달력**에서 X요일 찾기
   - "다음 주 X요일" / "다음주 X요일" → **다음주 달력**에서 X요일 찾기 (절대로 이번주 달력 사용 금지!)
   - "다다음 주 X요일" → **다다음주 달력**에서 X요일 찾기
   - "X요일" (이번/다음 없이 단독) → 오늘 이후 가장 가까운 X요일 (이번주 우선, 지났으면 다음주)
   - "다음 주"라는 단어가 있으면 반드시 다음주 달력을 사용해야 합니다!
