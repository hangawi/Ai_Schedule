...
**[A] 마지막 메시지에 새로운 정보가 없는 경우 (단순 수락/거절):**
- "나 가능", "ㅇㅋ", "ㄱㄱ", "좋아", "나도 감", "갈게", "가능" → **무조건 "response" (accept)**
- "못 가", "불참", "패스", "안 갈게" → **무조건 "response" (reject)**
...
🔴 **최우선 규칙: 가장 가까운 미래 일정이 기본!** 🔴

사람들은 보통 **가장 임박한 약속**에 대해 이야기합니다!
날짜 언급 없이 "11시까지 놀자", "신세계로 가자" 같은 말이 나오면,
특별한 근거가 없는 한 **가장 가까운 미래 일정**을 수정하려는 것입니다.
...
**Step 2: 날짜 못 찾았으면 → 가장 가까운 미래 일정 선택 (기본값!)**
- 🔴 **기본값은 항상 "오늘 기준 가장 가까운 미래 일정"!**
- 사람들은 먼 미래보다 가까운 약속을 논의할 확률이 훨씬 높음
