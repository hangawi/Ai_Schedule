...
1. **그리드 형식 시간표 (가장 중요!)**:
   - 가로축: 요일 (월, 화, 수, 목, 금, 토, 일)
   - 세로축: 교시 (1교시, 2교시, ...) 또는 시간대
   - 각 셀에 과목명이 있음
   - 예: "월요일 1교시 = 수학" → {"title": "수학", "days": ["월"], "startTime": "09:00", "endTime": "09:50"}

2. **교시 시간 매핑** (초등학교 기준, 40분 수업 + 10분 휴식):
   - 1교시: 09:00-09:40
   - 2교시: 09:50-10:30
   - 3교시: 10:40-11:20
   - 4교시: 11:30-12:10
   - 5교시: 13:00-13:40 (점심시간 후)
   - 6교시: 13:50-14:30
   - 7교시: 14:40-15:20
   - 8교시: 15:30-16:10

3. **중복/선택 수업 처리**:
   - 같은 시간대에 여러 과목이 있으면 **모두 별도의 일정으로 추출**
   - 예: "3-5시 수학/과학" → 두 개의 일정으로 분리
     * {"title": "수학", "startTime": "15:00", "endTime": "17:00", ...}
     * {"title": "과학", "startTime": "15:00", "endTime": "17:00", ...}
